            ...
            <div class="card-header bg-primary"><h3>Student Profile<h3></div><br>
                <div class="card-block">
                        <table class='table  table-hover table-striped'>
                            <tr><th>First Name</th><td>{{$profile[0]->f_name}}</td></tr>
                            <tr><th>Last Name</th><td>{{$profile[0]->l_name}}</td></tr>
                            <tr><th>Phone Number</th><td>{{$profile[0]->phone}}</td></tr>
                            <tr><th>Email Id</th><td>{{$profile[0]->email}}</td></tr>
                            <tr><th>Enrollment Number</th><td>{{$profile[0]->enrollmentno}}</td></tr>
                            <tr><th>Date of Birth</th><td>{{$profile[0]->dob}}</td></tr>
                            <tr>
                                <th>Gender</th>
                                <td>
            ...
            <div class="card-header bg-primary"><h3>Update Student Profile<h3></div><br>
                <div class="card-block">
                          ...
                          {{ csrf_field() }}
                              ...
                              <table class='table  table-hover table-striped'>
                                      <tr><th>First Name</th>
                                          <td><input type="text" id="f_name" name="f_name" value="{{$profile[0]->f_name}}" class="form-control"></td></tr>
                                      <tr><th>Last Name</th>
                                          <td><input type="text" id="l_name" name="l_name" value="{{$profile[0]->l_name}}" class="form-control"></td></tr>
                                      <tr><th>Phone Number</th>
                                          <td><input type="text" id="phone" name="phone" value="{{$profile[0]->phone}}" class="form-control"></td></tr>
                                      <tr><th>Email Id</th>
                                          <td><input type="text" id="email" name="email" value="{{$profile[0]->email}}" class="form-control"></td></tr>
                                      <tr><th>Enrollment Number</th>
                                          <td><input type="text" id="enrollment" name="enrollment" value="{{$profile[0]->enrollmentno}}" class="form-control"></td></tr>
                                      <tr><th>Date of Birth</th>
                                          <td><input type="text" id="dob" name="dob" value="{{$profile[0]->dob}}" class="form-control"></td></tr>
